...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            <form method="post" action="./services/_editPackage.php" class="new-package-form" enctype="multipart/form-data">
                ...
                <div class="form-inner">
                    ...
                    <div class="input-group">
                        ...
                        <input type="file" name="master-img" id="master-img" accept="image/*">
                        <?php if ($master_image): ?>
                            <img src="../<?php echo $master_image ?>" alt="Current Master Image" style="max-width:100px;display:block;margin-top:8px;">
                        <?php endif; ?>
                    </div>
                    <div class="row">
                        <div class="input-group">
                            <label for="ex1">Extra Image 1</label>
                            <input type="file" name="ex1" id="ex1" accept="image/*">
                            <?php if ($extra_image_1): ?>
                                <img src="../<?php echo $extra_image_1 ?>" alt="Extra Image 1" style="max-width:100px;display:block;margin-top:8px;">
                            <?php endif; ?>
                        </div>
                        <div class="input-group">
                            <label for="ex2">Extra Image 2</label>
                            <input type="file" name="ex2" id="ex2" accept="image/*">
                            <?php if ($extra_image_2): ?>
                                <img src="../<?php echo $extra_image_2 ?>" alt="Extra Image 2" style="max-width:100px;display:block;margin-top:8px;">
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="row">
