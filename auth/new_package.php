...
<body>
    ...
    <div class="container">
        ...
        <div class="content">
            <form method="post" action="./services/_newPackage.php" enctype="multipart/form-data" class="new-package-form">
                <div class="form-inner">
                    ...
                    <div class="input-group">
                        ...
                        <input required type="file" name="master-img" id="master-img">
                    </div>
                    <div class="row">
                        <div class="input-group">
                            <label for="ex1">Extra Image 1</label>
                            <input type="file" name="ex1" id="ex1">
                        </div>
                        <div class="input-group">
                            <label for="ex2">Extra Image 2</label>
                            <input type="file" name="ex2" id="ex2">
                        </div>
                    </div>
                    <div class="row">
