...
<body>
    ...
    if ($res->num_rows == 0) {
        ...
        if ($row["is_hotel"] == 1) {
            ...
            <span>
                Hotel is<strong class='brand-inline brand'>TMS </strong> verified with excellent
                customer service.
            </span>
        </li>";
        }
        ...
        <div class='package-title'>
            ...
            <div class='row'>
                ...
                <div>
                    <p>Location:<span>" . $row["package_location"] . "</span></p>
                </div>
            </div>
        </div>";
        echo "
        ...
        <div class='small-details'>
            ...
            <h4>" . $row["package_price"] . " KWACHA / All Inclusive</h4>
            <div>
                <hr class='line'>";
            ...
            $.ajax({
                ...
                error: (data) => {
                    if (data.status === 403) {
                        ...
                        $(".status-msg").html("Package not found.");
                    } else {
                        $(".status-msg").html("An error occurred.");
                    }
                    $(".btn-activate").html("Check Availability");
                },
            });
