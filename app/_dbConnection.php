...
{
    public function createPackage($package_name, $package_desc, $package_start, $package_end, $package_price, $package_location, $is_hotel, $is_transport, $is_food, $is_guide, $package_capacity,$master_image, $extra_image_1, $extra_image_2)
    {
        $this->connect();
        ...
        $sql = "INSERT INTO packages (package_name,package_desc,package_start,package_end,package_price,package_location,is_hotel,is_transport,is_food,is_guide,package_capacity,master_image,extra_image_1,extra_image_2)
        VALUES
        ('" . $package_name . "', '" . $package_desc . "', '" . $package_start . "', '" . $package_end . "', '" . $package_price . "', '" . $package_location . "', '" . $is_hotel . "', '" . $is_transport . "', '" . $is_food . "', '" . $is_guide . "', '" . $package_capacity . "', '" . $master_image . "', '" . $extra_image_1 . "', '" . $extra_image_2 . "')";
    ...
    public function updatePackage($package_id, $package_name, $package_desc, $package_start, $package_end, $package_price, $package_location, $is_hotel, $is_transport, $is_food, $is_guide, $package_capacity, $master_image, $extra_image_1, $extra_image_2)
    {
        $this->connect();
        $package_name = mysqli_real_escape_string($this->conn, $package_name);
        $package_desc = mysqli_real_escape_string($this->conn, $package_desc);
...
class Users extends Database
{
    ...
    {
        $this->connect();
        $sql = "SELECT * FROM users WHERE is_admin = 0 ORDER BY date_created DESC LIMIT $limit ";
        $result = $this->conn->query($sql);
