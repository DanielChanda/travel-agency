    ...
    <div class='container'>
        <div class='list-container'>
            <div class='left-col'>
                ...
                <h1>Find Your Suitable Package in <span class='brand'>TMS</span></h1>
                ...
                while ($row = mysqli_fetch_assoc($res)) {
                    ...
                    echo "<br>
                        ...
                        <div class='package-price'>
                            <h4>" . $row['package_price'] . " KWACHA <span>All Inclusive</span></h4>
                        </div>
                    </div>
                </div>";
                }
            ...
            <div class='right-col'>
                ...
                <div class='sidebar'>
                    <p>Search for your desired destination and get <span class="brand brand-inline">TMS</span> selected packages.</0>
        ...
        const addPackage = (package) => {
            ...
            document.querySelector(".package-container")
                ...
                <div class='package-info'>
                    ...
                    <div class='package-price'>
                        <h4>${package_price} KWACHA <span>Starting Price</span></h4>
                    </div>
                </div>
            </div>`;
        };
